...
const shakingBall = c => {
  ...
  const baseVerocity = Canv.canvas.width / 500; // we difine verocity as a function since that will be assign in a loop fnction
  ...
  Canv.loop(() => {
    Canv.drawBG(bgcolor); // calucurate and assgin verocity property
